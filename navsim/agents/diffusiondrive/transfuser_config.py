...
class TransfuserConfig:
    ...
    bkb_path: str = "/data_storage/haoruiyang/.cache/huggingface/hub/checkpoints/resnet34.a1_in1k/pytorch_model.bin"
    plan_anchor_path: str = "/data_storage/haoruiyang/projects/mme2e/DiffusionDrive/kmeans_navsim_traj_20.npy"
